...
const LeftLogin = () => {
    ...
    return (
        <div>
            <div className="left-login relative w-[50dvw] max-sm:h-[50vh] h-[100dvh] bg-[var(--white)] flex items-center justify-center">
                <div className="w-[50%] relative h-[55%] flex items-center justify-center m-9 shadow-[27px_27px_69px_rgb(219,215,219)] inset-[-27px_-27px_69px_rgb(255,255,255)] rounded-2xl border-[var(--black)]">
                    ...
                    <div className="flex flex-col size-full items-center justify-center" >
                        ...
                        <button onClick={submitLogin} disabled={load} className={`w-[20%] h-[8%] border-solid border-2 border-[var(--black)] rounded-2xl ${load ? "bg-[var(--purple)] opacity-45 text-[var(--white)] cursor-not-allowed" : "hover:bg-[var(--purple)]"}`} type="submit"> {load? "Wait..": "Login"}</button>
                    </div>
